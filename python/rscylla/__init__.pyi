...
class SessionBuilder:
    ...
    def compression(self, compression: Optional[str]) -> SessionBuilder: ...
    def tcp_nodelay(self, nodelay: bool) -> SessionBuilder: ...
    def tcp_keepalive(self, keepalive_ms: Optional[int]) -> SessionBuilder: ...
...
class Session:
    ...
    def execute(self, query: str, values: Optional[Dict[str, Any]] = None) -> QueryResult: ...
    def query(self, query: Query, values: Optional[Dict[str, Any]] = None) -> QueryResult: ...
    def prepare(self, query: str) -> PreparedStatement: ...
    def execute_prepared(
        self, prepared: PreparedStatement, values: Optional[Dict[str, Any]] = None
    ) -> QueryResult: ...
    ...
    def get_keyspace(self) -> Optional[str]: ...
...
class QueryResult:
    ...
    def first_row_typed(self) -> Optional[Dict[str, Any]]: ...
    def rows_typed(self) -> List[Dict[str, Any]]: ...
    def col_specs(self) -> List[Dict[str, Any]]: ...
    def tracing_id(self) -> Optional[str]: ...
